<?php
/*
Plugin Name: WP Twitter Sidebar Widget
Version: 3.0
...
Author: Max Steel
Author URI: http://www.dallasprowebdesigners.com/free-wordpress-plugins.html
*/

/*  Copyright 2010  Max Steel (info@dallasprowebdesigners.com)
...
function twitter_messages($username = '', $num = 1, $list = false, $update = true, $linked  = '#', $hyperlinks = true, $twitter_users = true, $encode_utf8 = false) {
	...
	if ($username == '') {
		...
		if ($list) echo '</ul>';
						echo '<div class="designed" style="font-size:9px; text-align: center;">'; //client can opt in or out
                      $name = "Web Design Company"; //setup for use to opt in or out for in admin section
